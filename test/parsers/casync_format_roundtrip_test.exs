...
defmodule AriaStorage.Parsers.CasyncFormatRoundtripTest do
  ...
  describe("caidx roundtrip tests") do
    ...
    test "empty caidx roundtrip is bit-exact" do
      empty_caibx =
        <<48::little-64, 10_845_316_187_136_630_777::little-64, 0::little-64, 16_384::little-64,
          65_536::little-64, 262_144::little-64>>
    ...
    defp create_caidx_test_data() do
      ...
      table_item = <<2_048::little-64>> <> chunk_id
    ...
    test "empty index file roundtrips correctly" do
      empty_caibx =
        <<48::little-64, 10_845_316_187_136_630_777::little-64,
          2_305_843_009_213_693_952::little-64, 16_384::little-64, 65_536::little-64,
          262_144::little-64>>
  ...
  defp create_synthetic_caibx do
    ...
    table_items =
      <<1_024::little-64>> <>
        chunk1_id <> <<2_048::little-64>> <> chunk2_id <> <<3_072::little-64>> <> chunk3_id
